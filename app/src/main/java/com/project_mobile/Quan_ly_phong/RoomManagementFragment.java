...
public class RoomManagementFragment extends Fragment implements RoomAdapter.OnRoomClickListener {
    ...
    public void onRoomClick(RoomModel room) {
        ...
        bottomSheet.setOnStatusChangedListener(newStatus -> {
            // Cập nhật trạng thái trong list và refresh adapter
            room.setStatus(newStatus);
            adapter.notifyDataSetChanged();
            // Ở đây có thể thêm logic cập nhật số lượng phòng ở các card summary nếu cần
        });
